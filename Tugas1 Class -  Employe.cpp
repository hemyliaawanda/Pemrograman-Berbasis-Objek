...
int main()
{
	cout << "\t\t Salary" <<endl;
	cout << "=====================================================================" <<endl<<endl;
	Employee Employee1("Lala","Lisa",2000000);
	Employee Employee2("krystal","Jung",2350000);
	cout << "EMPLOYEE 1 : "<< Employee1.getFirstName()<<" "<< Employee1.getLastName()<<endl;
	cout << "Month Salary : "<< Employee1.getMonthlySalary()<<endl;
	cout << "Year Salary : "<< Employee1.getMonthlySalary()*12<< endl<<endl;
	...
	cout << "Employee's month Salary' : "<< Employee1.getMonthlySalary()<<endl;
	cout << "Employee's year Salary : "<< Employee1.getMonthlySalary()*12 <<endl<<endl;

 	cout << endl;

	cout << "EMPLOYEE 2 : "<< Employee2.getFirstName()<<" "<< Employee2.getLastName()<<endl;
	cout << "Month Salary : "<< Employee2.getMonthlySalary() <<endl;
	cout << "Year Salary: "<< Employee2.getMonthlySalary()*12 <<endl<<endl;
	cout << "SETELAH KENAIKAN 10% :"<<endl;
	...
	cout<< "Employee's month Salary : "<< Employee2.getMonthlySalary() << endl;
	cout<< "Employee's year Salary : "<< Employee2.getMonthlySalary()*12<< endl<<endl;
	cout << "=====================================================================" <<endl<<endl;
}
